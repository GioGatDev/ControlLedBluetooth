...
public class DeviceList extends ActionBarActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.lista_de_dispositivos);
        ...
        {
            //Preguntamos al usuario si desea encender el bluetooth en caso de que se tenga desactivado
            Intent turnBTon = new Intent(BluetoothAdapter.ACTION_REQUEST_ENABLE);
            startActivityForResult(turnBTon,1);
        }

        //Creación del evento al hacer click en el botón de dispositivos vinculados
    ...
    //En esta clase se genera un array con todos los dispositivos bluetooth registrados en el dispositivo
    private void listaDispositivosvinculados()
    {
        ...
        {
            Toast.makeText(getApplicationContext(), "No se han encontrado dispositivos vinculados", Toast.LENGTH_SHORT).show();
        }
    ...
    private AdapterView.OnItemClickListener myListClickListener = new AdapterView.OnItemClickListener()
    {
        ...
        {
            // Se obtienen las MAC address, the last 17 chars in the View
            String info = ((TextView) v).getText().toString();
            String address = info.substring(info.length() - 17);

            // Se realiza un intent al iniciar la siguiente actividad
